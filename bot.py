...
# ══════════════════════════════════════════════════════════════
#  PERSISTENT DATA STORE  (data.json — survives Railway restarts
#  if you mount a volume at /data and set DATA_FILE=/data/data.json)
# ══════════════════════════════════════════════════════════════
...
def set_user_accounts(tg_id: int, accounts: list):
    data = load_data()
...
async def button_handler(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── ADMIN ─────────────────────────────────────────────────
        ...
        for tg_id, accs in data_store["accounts"].items():
