        ...
        if 'message' in update:
            ...
            # Handle offer delete mode
                ...
                try:
                    ...
                    try:
                        ...
                        send_message(chat_id, "❌ Invalid Offer ID format. Must be 24 character hex string.")
                        return 'ok', 200
            ...
            # Handle offer edit mode
                ...
                try:
                    ...
                    send_message(chat_id, f"❌ Error: Invalid delay values. Delays must be numbers.", reply_markup=admin_keyboard())
                except Exception as e:
                    send_message(chat_id, f"❌ Error: {str(e)}", reply_markup=admin_keyboard())
        ...
        # Handle callback queries
            ...
            # Offer list
                ...
                if offers:
                    ...
                    for i, offer in enumerate(offers, 1):
                        status = "✅" if offer.get('enabled', True) else "❌"
            ...
            # Offer edit button
                ...
                send_message(
                    ...
                    "Get ID from: Manage Offers → List Offers\n\n"
                    "Example:\n"
                    "<code>507f1f77bcf86cd799439011|MyOffer|https://example.com|https://api.com?id=$id|0</code>"
                )
